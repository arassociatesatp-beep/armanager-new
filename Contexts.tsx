...
export const DataContext = React.createContext<{
  ...
  updateGlobalTransactionByExpenseId: (expenseId: number, newAmount: string, description?: string, newDate?: string) => void;
  deleteGlobalTransactionByExpenseId: (expenseId: number) => void;
  deleteGlobalTransactionByPaymentId: (paymentId: number) => void;
  updateGlobalTransactionByPaymentId: (paymentId: number, newAmount: string, description?: string, newDate?: string) => void;
